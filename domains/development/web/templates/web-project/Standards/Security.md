<!-- Derived from ~/.claude/skills/security/SKILL.md
...
1. [Core Principles](#1-core-principles) - Security philosophy
2. [Input Validation](#2-input-validation) - Preventing injection attacks
3. [Authentication & Authorization](#3-authentication--authorization) - User identity and access control
4. [Data Protection](#4-data-protection) - Encryption and sensitive data handling
5. [API Security](#5-api-security) - Secure API design
6. [Secrets Management](#6-secrets-management) - Handling credentials and keys
7. [File Upload Security](#7-file-upload-security) - Safe file handling
8. [Logging & Monitoring](#8-logging--monitoring) - Security event tracking
9. [OWASP Top 10](#9-owasp-top-10) - Common vulnerabilities to avoid
10. [Security Checklist](#10-security-checklist) - Pre-release verification
