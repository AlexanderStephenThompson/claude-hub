...
- **Web project template** at `domains/development/web/templates/web-project/` — Project roadmap template + README referencing architecture skill.
...
- **project-roadmap-template.md** — Moved to `domains/development/web/templates/web-project/project-roadmap.md`.
...
### Added
- **Domain folder structure** — Organized repo into `foundations/`, `domains/development/web/`, `domains/development/gamedev/`, `domains/data/`. Sync deploys flat to `~/.claude/`.
...
- **gamedev reorganized** — Skills moved into sub-categories (`unity/`, `vr-chat/`) under `domains/development/gamedev/`. Sync updated for recursive discovery.
- Moved implement-team from `domains/development/web/teams/` to `foundations/teams/` (universal, not web-specific)
