...
1. Copy the entire `skill/` folder to `<domain>/skills/[skill-name]/`
...
- Skills live in domain folders (`foundations/skills/`, `development/web/skills/`, etc.), not inside teams
