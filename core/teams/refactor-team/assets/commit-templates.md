...
Use these templates for consistent, informative commit messages during both clean and refactor phases.
...
## Clean Phase Templates

### Organizer

```
chore(structure): organize project files and folders
...
```
refactor(quality): clean code — universal + [project-type] conventions
...
- [Type-specific changes, e.g., "Consolidated CSS to 5-file structure"]
...
|-------------|-----------------|
| Structure cleanup | `chore(structure): organize project files` |
| Code cleaning | `refactor(quality): clean code — universal + web conventions` |
